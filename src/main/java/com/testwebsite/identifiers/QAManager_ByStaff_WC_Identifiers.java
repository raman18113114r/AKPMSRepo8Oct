...
public class QAManager_ByStaff_WC_Identifiers 
{
	
	public static String clickQAManager = "//span[text()='QA Manager']";
	public static String clickQAWorkSheet = "//a[text()='QA Work Sheet']";
	public static String clickByStaffRadio = "(//span[@class='mat-radio-container'])[2]";
	...
	public static String clickSelectStaffDropdown = "(//span[@class='dropdown-multiselect__caret'])[2]";
	public static String enterNameinSelectStaff = "(//input[@placeholder='Search here....'])[2]";
	public static String selectStaffAsRahulJawa = "(//div[text()='Rahul Jawa Ids'])[2]";
	public static String clickOutSideSelectStaff = "//label[text()='Billing Month']";
	public static String enterPercentageStaff = "//input[@placeholder='%']";
	public static String clickAddStaffButton = "//span[text()='Add Staff']";
	public static String clickOnCrossButton = "//span[text()='Close']";
}
